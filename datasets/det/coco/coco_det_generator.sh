...
TRAIN_SAVE_DIR='/home/donny/DataSet/COCO_MASK/train'
VAL_SAVE_DIR='/home/donny/DataSet/COCO_MASK/val'


python coco_pose_generator.py --save_dir $TRAIN_SAVE_DIR \
                              --anno_file $TRAIN_ANNO_FILE \
                              --ori_img_dir $COCO_TRAIN_IMG_DIR

python coco_pose_generator.py --save_dir $VAL_SAVE_DIR \
